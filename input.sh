...
TBB_COMPILER_FLAGS="-std=c++14 -O3 -ltbb"
...
OMP_COMPILE_FIXIT_COMMAND="$COMPILER $LFLAGS $OMP_COMPILER_FLAGS $SOURCE_FIXIT_NAME -o bin_$SOURCE_FIXIT_NAME"
# to compile the file generated by the openacc fixit command
ACC_COMPILE_FIXIT_COMMAND="$COMPILER $LFLAGS $ACC_COMPILER_FLAGS $SOURCE_FIXIT_NAME -o bin_$SOURCE_FIXIT_NAME"
# to compile the file generated by the cilk fixit command
CILK_COMPILE_FIXIT_COMMAND="$COMPILER $LFLAGS $CILK_COMPILER_FLAGS $SOURCE_FIXIT_NAME -o bin_$SOURCE_FIXIT_NAME"
# to compile the file generated by the hpx fixit command
HPX_COMPILE_FIXIT_COMMAND="$COMPILER $LFLAGS $SOURCE_FIXIT_NAME -o bin_$SOURCE_FIXIT_NAME $HPX_COMPILER_FLAGS "
# to compile the file generated by the tbb fixit command
TBB_COMPILE_FIXIT_COMMAND="$COMPILER $LFLAGS $SOURCE_FIXIT_NAME -o bin_$SOURCE_FIXIT_NAME $TBB_COMPILER_FLAGS "
